...
const BuyItem = () => {
  ...
  const data = [
    { text: "Phones", icon: <IoMdPhonePortrait /> },
    { text: "Laptops", icon: <BsLaptop /> },
    { text: "TV", icon: <BsTv /> },
    { text: "Gaming Gadgets", icon: <IoLogoGameControllerA /> },
    { text: "Home Appliances", icon: <RiFridgeLine /> },
  ];
  ...
  const allItems = data.map((item, index) => {
    return (
      <Link
        key={index}
        style={{ color: "black" }}
        to={url + "/" + item.text.toLowerCase().replace(/ /g, "-") + "-brands"}
      >
      ...
      <Switch>
        <Route exact path={path}>
          <div className="buy-grid">
            <p className="centered-text theme-text">
              ...
              >
                ...
                >
                  <div className="buy-text">
                    Choose your Category of choice or search
                  </div>
                ...
                <div className="buy-items">{allItems}</div>
              </div>
            </div>
          </div>
        </Route>
